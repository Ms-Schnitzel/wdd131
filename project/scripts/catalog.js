export const movies = [
  ...
  },
  {
    ...
    img: "./img/shrek-1.jpg",
    tags: ["comedy", "adventure", "romance", "fantasy", "animated"],
    trending: true
  },
  {
    name: "Shrek 2",
  ...
  },
  {
    ...
    img: "./img/kpop.jpg",
    tags: ["action", "comedy", "fantasy", "animated"],
    trending: false
  }
];
export const shows = [
  ...
  },
  {
    ...
    description: "In a war-torn world of elemental powers, a young boy reawakens to undertake a dangerous mystic quest to fulfill his destiny as the Avatar, and bring peace to the world.",
    img: "./img/avatar.jpg",
    tags: ["action", "adventure", "comedy", "animated", "fantasy"],
    trending: false
  },
  {
  ...
  },
  {
    ...
    tags: ["comedy", "adventure", "fantasy", "animated", "action"],
    trending: false
  },
  {
    name: "Chowder",
    description: "In Marzipan City, excitable young food-loving Chowder is the apprentice of Mung Daal, a very old chef who runs a catering company with his wife Truffles and assistant Shnitzel.",
    img: "./img/chowder.jpg",
    tags: ["adventure", "comedy", "fantasy", "animated"],
    trending: false
  },
  {
  ...
  },
  {
    ...
    img: "./img/jujutsu.jpg",
    tags: ["action", "adventure", "fantasy", "animated"],
    trending: false
  }
];
...
export const setBoxDisplay = (media) => {
  clearDisplay();
